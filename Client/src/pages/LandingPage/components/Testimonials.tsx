            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                        ...
                        Real people, real results. See how our AI-powered tools have
                        transformed careers across industries.
                            ...
                            >
                                ...
                                <div className="flex items-center mb-6">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-blue-600 font-medium">{t.company}</p>
                                ...
                                <div className="relative">
                                    ...
                                    <FaQuoteLeft className="absolute -top-2 -left-2 w-6 h-6 text-gray-300" />
