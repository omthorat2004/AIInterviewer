import { FaCheck, FaBolt, FaBullseye, FaCrown, FaArrowRight } from "react-icons/fa";
                        ...
                        plans.map((plan, index) => {
                            ...
                            return (
                                ...
                                <div
                                    ...
                                    className={`relative bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border-2 ${plan.popular ? "border-blue-500 scale-105" : "border-gray-200"
                                ...
                                >
                                    ...
                                    <div className="p-8">
                                        ...
                                        <button
                                            ...
                                            className={`w-full py-4 px-6 rounded-lg font-semibold text-lg transition-all duration-300 flex items-center justify-center gap-2 ${plan.popular
